                ...
                <div class="col-md-8 ">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword18">ShopName</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword17">Account_Holder</label>
                                    <p>{{$view->account_holder}}</p>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword41">Account_Number</label>
                                    <p>{{$view->account_number}}</p>
                                </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputPassword13">Bank_Branch</label>
