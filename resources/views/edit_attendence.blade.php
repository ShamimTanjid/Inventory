	              ...
	              <div class="panel panel-default">
	                  <div class="panel-heading">
	                      <h3 class="panel-title">Update Attendence
	                      	<a href="{{route('all.attendence')}}"class="btn btn-sm btn-info pull-right"> All Attendance</a></h3>
	                  </div>
	                  ...
	                  <div class="panel-body">
	                      <div class="row">
	                          <div class="col-md-12 col-sm-12 col-xs-12">
	                              <table {{--id="datatable"--}} class="table table-striped table-bordered">
	                                  ...
	                                  <tbody>
	                                  	<form  method="post" action="{{URL::to('/update-attendence')}}"  enctype="multipart/form-data">
	                                  		@csrf
	                                  	@foreach($data as $row)
	                                      <tr>
	                                          <td>{{ $row->name }}</td>
                        ...
                        <button type="submit" class="btn btn-success"align="center">Update Attendence</button>
                               </form>
	                          </div>
	                      </div>
	                  </div>
