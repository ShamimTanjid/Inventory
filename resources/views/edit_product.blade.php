                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                  <img id="image" src="#" />
                                    ...
                                    <input type="file"  name="product_imgage" accept="image/*"   onchange="readURL(this);">
                                </div>
                                <input type="hidden" name="old_photo" value="{{ $edit->product_imgage }}">
                               <div class="form-group">
                                    <label for="exampleInputPassword12">Old Photo</label>
                                   <img src="{{ URL::to($edit->product_imgage) }}" style="height: 80px; width: 100px;">
                                </div>
