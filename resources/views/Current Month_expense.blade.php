              ...
              <div class="col-md-12">
                  ...
                  <div class="panel panel-default">
                      <div class="panel-heading">
                          <h3 class="panel-title  text-danger">{{date("F")}}    Month expense
                      ...
                      <div class="panel-body">
                          <div class="row">
                              <div class="col-md-12 col-sm-12 col-xs-12">
                               ...
                               @php
                               $month=date("F");
                               $ctotal=DB::table('expenses')->where('month',$month)->sum('amount');
                               @endphp
                             <h4 align="center"; class="text-danger">Total Expense:{{$ctotal}} Taka</h4>
